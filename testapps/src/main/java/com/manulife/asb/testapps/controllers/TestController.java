...
public class TestController {
    ...
    // @GetMapping("/send")
    // public String send(ModelMap m){
    //     m.addAttribute("model", new ASBSenderModel());
    //     return "send";
    // }
    ...
    public String send(ModelMap m, @RequestBody ASBSenderModel model){
        ...
        try{
            ...
            if(
                model.getCustomPropKey() != null && !model.getCustomPropKey().isEmpty()
                &&
                model.getCustomPropValue() != null && !model.getCustomPropValue().isEmpty()
            ){
                asbMsg.getApplicationProperties().put(model.getCustomPropKey(), model.getCustomPropValue());
            }
    ...
    // @GetMapping("/receive")
    // public String receive(ModelMap m){
    //     m.addAttribute("model", new ASBReceiverModel());
    //     return "receive";
    // }
